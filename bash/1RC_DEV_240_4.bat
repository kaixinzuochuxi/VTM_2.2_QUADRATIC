...
start	.\RC_266_DEV.bat	RaceHorses_416x240_30	4102340	%encoder%	%encoding_mode% "--LCULevelRateControl=0"
start	.\RC_266_DEV.bat	RaceHorses_416x240_30	2490414.4	%encoder%	%encoding_mode% "--LCULevelRateControl=0"
start	.\RC_266_DEV.bat	RaceHorses_416x240_30	1387984.8	%encoder%	%encoding_mode% "--LCULevelRateControl=0"
start	.\RC_266_DEV.bat	RaceHorses_416x240_30	689338.4	%encoder%	%encoding_mode% "--LCULevelRateControl=0"
